...
In this LearnPack, you will practice TypeScript by solving progressive exercises about functions, collections, and structured data handling.

## Suggested workflow

1. Read the exercise instructions.
2. Implement your solution in `app.ts`.
3. Click **Run** to inspect the output.
4. Click **Test** and iterate until all tests pass.

## Curriculum structure

- **Skill 7.2** (Functions and flow): `001-042`
- **Skill 8.1** (Collections: arrays and matrices): `043-115`
